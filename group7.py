...
# Lasso Regression
lasso_model = linear_model.Lasso(alpha=1/(2*0.001), max_iter=10000)
...
# Ridge Regression
ridge_model = linear_model.Ridge(alpha=1/(2*0.001), max_iter=1000)
...
kNN_R2 = r2_score(y_test,kNN_ypred)
print("kNN - MSE = ", kNN_MSE, ", R2 = ", kNN_R2)
